...
export default function ButtonMore() {
  ...
  return (
    <div className="flex flex-row items-center justify-start p-1 rounded-md border-white/60 border self-end" onMouseEnter={() => setisHov(true)} onMouseLeave={() => setisHov(false)}>
        <div className={`flex flex-row items-center justify-start ${isHov ? "gap-0" : "gap-3"} transition-all rounded-sm overflow-hidden relative`}>
            ...
            <div className="flex flex-row items-center justify-center px-2.5 py-2 bg-purpleN rounded-sm relative z-20">
                <div className="bg-purpleN inset-1 blur-lg absolute z-20"></div>
