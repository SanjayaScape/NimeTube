...
export default function ButtonMore({text = "View more" , onClick} : con) {
    const [isHov , setisHov] = useState(false)
  return (
    <div className="flex flex-row items-center justify-start p-1 rounded-md border-white/30 border self-end shrink-0 bg-black/30" onMouseEnter={() => setisHov(true)} onMouseLeave={() => setisHov(false)} onClick={ () => onClick && onClick() }>
