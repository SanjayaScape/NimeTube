...
export default function AnimeBar({con} : anime) {
  ...
  return (
    <div className={`w-full px-4 py-3 ${isHov ? "bg-purpleN/20" : "bg-purpleN/5"} rounded-sm flex flex-row items-start justify-start gap-4`} onMouseEnter={() => {setisHov(true)}} onMouseLeave={() => {setisHov(false)}}>
